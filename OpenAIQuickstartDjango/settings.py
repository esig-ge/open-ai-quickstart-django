"""
Django settings for OpenAIQuickstartDjango project.
...
ROOT_URLCONF = 'OpenAIQuickstartDjango.urls'
...
WSGI_APPLICATION = 'OpenAIQuickstartDjango.wsgi.application'
